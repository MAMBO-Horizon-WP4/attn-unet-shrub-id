...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_image", required=True, help="Path to save the output prediction"
    )
    parser.add_argument(
        "--window_size", type=int, default=512, help="Size of the sliding window"
    )
    parser.add_argument(
        "--step_size", type=int, default=256, help="Step size for sliding window"
    )
    parser.add_argument(
